function FAA_FirstBoutProp_Bi(all_boutn,options)
...
figure(1)
b=bar([1,2,2.8,3.2,4],all_percentage,.8,'stacked','FaceColor','flat','EdgeColor','None','BarWidth', 0.01); %% put the unilateral tgr
% alters the color
b(2).CData(1,:) = mycolor.baseline;b(2).CData(2,:) = mycolor.mainbi;
b(2).CData(3,:) = mycolor.mainleft;b(2).CData(4,:)= mycolor.mainright;b(2).CData(5,:)= mycolor.mainnull;
b(1).CData(1,:) = mycolor.baseline;b(1).CData(2,:) = mycolor.mainbi;
b(1).CData(3,:) = mycolor.mainleft;b(1).CData(4,:)= mycolor.mainright;b(1).CData(5,:)= mycolor.mainnull;
