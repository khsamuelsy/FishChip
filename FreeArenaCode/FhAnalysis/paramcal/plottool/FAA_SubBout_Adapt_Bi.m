...
nointactcad = boutn_vs_param(:,9:10);
% clear all NAN data
...
nointactcad(isnan(nointactcad(:,1)),:)=[];
...
temp2 = temp(~isnan(temp));
nointactcad = [nointactcad; repmat(1,length(temp2),1),temp2];
...
nointactcad(size(nointactcad,1)+1:10000,1:2) = nan;
names = {'intactwater','intactcad','leftintactcad','rightintactcad','nointactcad'};
